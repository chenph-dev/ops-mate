...
const FEATURES: Array<{ icon: string; title: string; desc: string }> = [
  { icon: '🖥️', title: '主机管理', desc: '文件夹树状组织主机、连接测试、命令执行' },
  { icon: '💻', title: 'SSH 终端', desc: '交互式终端，动态缩放、搜索、命令历史' },
  { icon: '📁', title: 'SFTP 传输', desc: '远程文件浏览与上传下载，并发队列 + 进度控制' },
  { icon: '🤖', title: 'AI 运维智能体', desc: '命令审批 / 计划模式，每一步都经你确认' },
];
