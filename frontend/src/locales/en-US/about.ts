export default {
  ...
  feat: {
    ...
    sftpDesc: 'Remote file browsing and upload/download, concurrent queue + progress control',
    aiTitle: 'AI ops agent',
    aiDesc: 'Command approval / plan mode, every step confirmed by you',
  },
  techstack:
    'Stack: Go + Eino | React + Ant Design + xterm.js | SQLite + GORM',
};
