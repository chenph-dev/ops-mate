export default {
  title: 'Ops Skills',
  subtitle:
    'Packaged per Anthropic Agent Skills spec (SKILL.md + scripts/). Upload a ZIP; the Agent can load the guide on demand and run scripts remotely on the target asset.',
